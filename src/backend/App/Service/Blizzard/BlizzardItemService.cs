...
namespace AuctionMaster.App.Service.Blizzard
{
    ...
    /// about Auction House.
    /// </summary>
    public class BlizzardItemService : BlizzardService, IBlizzardItemService
    {
        // == DECLARATIONS
        // ======================================================================
        ...
        public BlizzardItemService(IConfiguration configuration, IHttpClientFactory httpClientFactory) : base(configuration, httpClientFactory)
        {
        ...
        public async Task<JObject> getItem(int id)
        {
            JObject retValue = null;
            String qpRegion = "us";
            String qpNamespace = "static-us";
            String qpLocale = "en_us";
            String accessToken = await getClientAccessToken();
            String endpoint = $"https://{qpRegion}.api.blizzard.com/data/wow/item/{id}?namespace={qpNamespace}&locale={qpLocale}&access_token={accessToken}";
