...
namespace AuctionMaster.App.Exception
{
    ...
    /// </summary>
    public class AuctionMasterDatabaseException : AuctionMasterException
    {
        // == DECLARATIONS
        // ======================================================================
        ...
        public AuctionMasterDatabaseException(ExceptionType type, String message) : base(type, message)
        {
        ...
        public AuctionMasterDatabaseException(ExceptionType type, String message, System.Exception innerException) : base(type, message, innerException)
        {
